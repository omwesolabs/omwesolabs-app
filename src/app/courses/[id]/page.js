                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="md:col-span-2 space-y-6">
                                        ...
                                        <div className="space-y-4">
                                            {course.semesters.map((semester) => (
                                                <div key={semester.number} className="border rounded-lg">
                                                    ...
                                                    >
                                                        <span
                                                            className="font-semibold">Semester {semester.number}</span>
                                ...
                                {activeTab === 'careers' && (
                                    <div className="space-y-6">
                                        ...
                                        <div className="bg-white rounded-xl shadow-lg p-6">
                                            <h2 className="text-xl font-bold mb-4">Companies That Hire Our
                                                Graduates</h2>
                                                ...
                                                <ul className="space-y-2">
                                                    {reqGroup.items.map((item, idx) => (
                                                        <li key={idx} className="flex items-center text-gray-600">
                                                            <div
                                                                className="h-1.5 w-1.5 bg-blue-600 rounded-full mr-2"></div>
                                                            {item}
                                                        </li>
                                                    ))}
                                                </ul>
                            ...
                            <div className="space-y-6">
                                ...
                                <div
                                    ...
                                    <p className="mb-4">Contact our academic advisors for guidance on program selection
                                        and
